...
object streamOnlyData {
  ...
  def main(args: Array[String]) {
    ...
    val sparkConf = new SparkConf()
      .set("spark.mongodb.input.uri","mongodb://127.0.0.1/twitter.streamOnly")
      .set("spark.mongodb.output.uri","mongodb://127.0.0.1/twitter.streamOnly")
      .setMaster("local[*]")
